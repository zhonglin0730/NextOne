    ...
    <div className="ritual-backdrop" role="presentation">
      ...
      >
        <header className="ritual-header">
          <div>
            <span className="ritual-step">{t("kickoff.open")}</span>
            <h2 id="kickoff-title">{t("kickoff.chooseTitle")}</h2>
            <p>{t("kickoff.chooseDescription", { limit: focusLimit })}</p>
          </div>
          <button
        ...
        <footer className="ritual-actions">
          ...
          <button
            ...
            type="button"
          >
            {starting ? t("common.saving") : t("kickoff.addSelected", { count: selectedIds.size })}
          </button>
        </footer>
      </section>
    </div>
